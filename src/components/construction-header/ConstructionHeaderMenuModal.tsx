  ...
  return (
    <div
      className={cn(
        ...
        "max-md:transition-[opacity,transform] max-md:duration-300 max-md:ease-out",
        enableFadeIn &&
          "max-md:opacity-0 max-md:peer-checked/menu:opacity-100",
        !enableFadeIn && "max-md:opacity-100",
        enableSlideIn &&
          "max-md:-translate-x-4 max-md:peer-checked/menu:translate-x-0",
        !enableSlideIn && "max-md:translate-x-0",
        // Desktop: in-flow / absolute right of header bar
        "md:absolute md:inset-y-0 md:right-0 md:z-30 md:flex md:items-center md:px-4",
        "md:visible md:pointer-events-auto md:opacity-100 md:translate-x-0",
        className,
      )}
    >
      <div
